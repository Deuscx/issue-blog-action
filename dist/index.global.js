...
(() => {
  ...
  var urlVariableRegex2, VERSION9, userAgent2, DEFAULTS2, endpoint2;
  var init_dist_web3 = __esm({
    "node_modules/.pnpm/@octokit+endpoint@6.0.12/node_modules/@octokit/endpoint/dist-web/index.js"() {
      ...
      urlVariableRegex2 = /\{[^}]+\}/g;
      VERSION9 = "6.0.12";
      userAgent2 = `octokit-endpoint.js/${VERSION9} ${getUserAgent()}`;
      DEFAULTS2 = {
        method: "GET",
      ...
      endpoint2 = withDefaults4(null, DEFAULTS2);
    }
  });
      ...
      RequestError2 = class extends Error {
        constructor(message, statusCode, options) {
          ...
          Object.defineProperty(this, "code", {
            get() {
              logOnceCode2(new Deprecation("[@octokit/request-error] `error.code` is deprecated, use `error.status`."));
              return statusCode;
            }
          });
          Object.defineProperty(this, "headers", {
            get() {
              logOnceHeaders2(new Deprecation("[@octokit/request-error] `error.headers` is deprecated, use `error.response.headers`."));
              return headers || {};
            }
          });
        }
  ...
  function withDefaults5(oldEndpoint, newDefaults) {
    ...
    const newApi = function(route, parameters) {
      ...
      Object.assign(request3, {
        endpoint: endpoint3,
        defaults: withDefaults5.bind(null, endpoint3)
      });
...
` + data.errors.map((e) => ` - ${e.message}`).join("\n");
  ...
  function withDefaults6(request$1, newDefaults) {
  ...
  var VERSION11, GraphqlResponseError2, NON_VARIABLE_OPTIONS2, FORBIDDEN_VARIABLE_OPTIONS2, GHES_V3_SUFFIX_REGEX2, graphql$12;
  var init_dist_web6 = __esm({
    "node_modules/.pnpm/@octokit+graphql@4.8.0/node_modules/@octokit/graphql/dist-web/index.js"() {
      ...
      graphql$12 = withDefaults6(request2, {
        headers: {
          "user-agent": `octokit-graphql.js/${VERSION11} ${getUserAgent()}`
        },
        method: "POST",
        url: "/graphql"
      });
  ...
  var REGEX_IS_INSTALLATION_LEGACY2, REGEX_IS_INSTALLATION2, REGEX_IS_USER_TO_SERVER2, createTokenAuth3;
  var init_dist_web7 = __esm({
    "node_modules/.pnpm/@octokit+auth-token@2.5.0/node_modules/@octokit/auth-token/dist-web/index.js"() {
      REGEX_IS_INSTALLATION_LEGACY2 = /^v1\./;
      REGEX_IS_INSTALLATION2 = /^ghs_/;
      REGEX_IS_USER_TO_SERVER2 = /^ghu_/;
      createTokenAuth3 = function createTokenAuth4(token2) {
        if (!token2) {
  ...
  var import_before_after_hook2, VERSION12, Octokit3;
      ...
      Octokit3 = class {
        constructor(options = {}) {
          ...
          requestDefaults.headers["user-agent"] = [
            options.userAgent,
            `octokit-core.js/${VERSION12} ${getUserAgent()}`
          ].filter(Boolean).join(" ");
          if (options.baseUrl) {
  ...
  function restEndpointMethods2(octokit) {
    const api = endpointsToMethods2(octokit, Endpoints2);
    return {
      rest: api
    };
  }
  ...
  var VERSION14, composePaginateRest2, paginatingEndpoints;
  ...
  var require_utils3 = __commonJS({
    "node_modules/.pnpm/@actions+github@5.1.1/node_modules/@actions/github/lib/utils.js"(exports) {
      ...
      function getOctokitOptions(token2, options) {
        ...
        const auth3 = Utils.getAuthString(token2, opts);
        if (auth3) {
          opts.auth = auth3;
        }
        return opts;
  ...
  var require_lib3 = __commonJS({
    "node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/index.js"(exports, module) {
      "use strict";
      module.exports = {
        ...require_fs(),
        ...require_copy2(),
...
Support boolean input list: \`true | True | TRUE | false | False | FALSE\``);
  ...
  // node_modules/.pnpm/@octokit+core@4.1.0/node_modules/@octokit/core/dist-web/index.js
  init_dist_web();
  var import_before_after_hook = __toESM(require_before_after_hook());

  // node_modules/.pnpm/@octokit+endpoint@7.0.3/node_modules/@octokit/endpoint/dist-web/index.js
  init_is_plain_object();
  init_dist_web();
  ...
  // node_modules/.pnpm/@octokit+request@6.2.2/node_modules/@octokit/request/dist-web/index.js
  init_dist_web();
  init_is_plain_object();
  init_lib();

  // node_modules/.pnpm/@octokit+request-error@3.0.2/node_modules/@octokit/request-error/dist-web/index.js
  init_dist_web2();
  ...
  function fetchWrapper(requestOptions) {
    ...
    let status;
    let url;
    const fetch2 = requestOptions.request && requestOptions.request.fetch || globalThis.fetch || lib_default;
    return fetch2(requestOptions.url, Object.assign(
      {
        method: requestOptions.method,
        body: requestOptions.body,
  ...
  // node_modules/.pnpm/@octokit+graphql@5.0.4/node_modules/@octokit/graphql/dist-web/index.js
  init_dist_web();
  var VERSION3 = "5.0.4";
...
` + data.errors.map((e) => ` - ${e.message}`).join("\n");
  ...
  function withDefaults3(request3, newDefaults) {
    const newRequest = request3.defaults(newDefaults);
    const newApi = (query, options) => {
  ...
  // node_modules/.pnpm/@octokit+auth-token@3.0.2/node_modules/@octokit/auth-token/dist-web/index.js
  ...
  // node_modules/.pnpm/@octokit+plugin-request-log@1.0.4_@octokit+core@4.1.0/node_modules/@octokit/plugin-request-log/dist-web/index.js
  var VERSION5 = "1.0.4";
  ...
  // node_modules/.pnpm/@octokit+plugin-paginate-rest@5.0.1_@octokit+core@4.1.0/node_modules/@octokit/plugin-paginate-rest/dist-web/index.js
  var VERSION6 = "5.0.1";
  ...
  // node_modules/.pnpm/@octokit+plugin-rest-endpoint-methods@6.7.0_@octokit+core@4.1.0/node_modules/@octokit/plugin-rest-endpoint-methods/dist-web/index.js
  var Endpoints = {
    actions: {
      addCustomLabelsToSelfHostedRunnerForOrg: [
        "POST /orgs/{org}/actions/runners/{runner_id}/labels"
  ...
  // node_modules/.pnpm/@octokit+rest@19.0.5/node_modules/@octokit/rest/dist-web/index.js
  var VERSION8 = "19.0.5";
  ...
  function toLinesWithContent(input = "", trimmed2 = true, separator = "\n") {
    return input.split(separator).reduce((output2, line) => {
      const lineContent = trimmed2 ? line.trim() : line;
      if (lineContent) {
        output2.push(lineContent);
      }
      return output2;
    }, []);
  }
  ...
  function filterPrimitives(input, omit3) {
    return /number|string|boolean/.test(typeof input) && (!omit3 || !omit3.includes(typeof input));
  }
  ...
  function createInstanceConfig(...options) {
    ...
    const config3 = Object.assign(__spreadValues({ baseDir: baseDir2 }, defaultOptions), ...options.filter((o) => typeof o === "object" && o));
    config3.baseDir = config3.baseDir || baseDir2;
  ...
  function onDataReceived(target, name, logger, output2) {
    return (buffer) => {
  ...
  function branchDeletionSuccess(branch2, hash) {
    return {
      branch: branch2,
      hash,
      success: true
  ...
  var init_parse_branch_delete = __esm2({
    "src/lib/parsers/parse-branch-delete.ts"() {
      ...
      parsers8 = [
        new LineParser(deleteSuccessRegex, (result, [branch2, hash]) => {
          const deletion = branchDeletionSuccess(branch2, hash);
  ...
  function errorDetectionPlugin(config3) {
    return {
      ...
      action(data, context2) {
        const error = config3(data.error, {
  ...
  var PluginStore = class {
    ...
    exec(type, data, context2) {
      ...
      for (const plugin of this.plugins) {
        if (plugin.type === type) {
          output2 = plugin.action(output2, contextual);
        }
      }
      return output2;
    }
    ...
    if (block > 0) {
      return {
        ...
        action(_data, context2) {
          ...
          (_a2 = context2.spawned.stdout) == null ? void 0 : _a2.on("data", wait);
          (_b = context2.spawned.stderr) == null ? void 0 : _b.on("data", wait);
  ...
  init_utils();
  var Git = require_git();
  function gitInstanceFactory(baseDir2, options) {
    const plugins = new PluginStore();
    const config3 = createInstanceConfig(baseDir2 && (typeof baseDir2 === "string" ? { baseDir: baseDir2 } : baseDir2) || {}, options);
    if (!folderExists(config3.baseDir)) {
      throw new GitConstructError(config3, `Cannot use simple-git on a directory that does not exist`);
    }
  ...
  (0, import_core2.debug)(`config:${JSON.stringify(config2)}`);
  async function generateIssues() {
    ...
    try {
      await commit();
      (0, import_core2.debug)("\u{1F680} Done!");
    } catch (error) {
      if (error instanceof Error)
        (0, import_core2.debug)(`commit error:  ${error.message}`);
    }
  }
  var baseDir = import_path.default.join(process.cwd(), getInput2("cwd") || "");
  var git = esm_default({ baseDir });
  function commit() {
